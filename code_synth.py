...
def _templates() -> list[Template]:
    return [
        ...
        Template(
            ...
            lambda low: bool(re.search(r"\bmedian\b", low)),
            ((([1, 3, 2],), 2), (([1, 2, 3, 4],), 2.5)),
        ),
        Template(
            "title_case",
        ...
        Template(
            ...
            lambda low: bool(
                re.search(
                    ...
                    r"\b(occurrences? of|how many times)\b",
                    low,
                )
            ),
            ((([1, 2, 1, 1], 1), 3), (([], 0), 0)),
        ...
        Template(
            ...
            "            hi = mid - 1\n"
            "    return -1\n",
            lambda low: bool(re.search(r"\bbinary[- ]?search(?:es|ed|ing)?\b|\bbinsearch\b|\bbinary_search\b", low)),
